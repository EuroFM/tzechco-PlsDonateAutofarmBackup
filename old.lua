...
if queueonteleport then
	queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/EuroFM/tzechco-PlsDonateAutofarmBackup/main/old.lua'))()")
end
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/EuroFM/tzechco-PlsDonateAutofarmBackup/main/UI"))()
local _HIGHLIGHTLOADER
pcall(function()
     _HIGHLIGHTLOADER = loadstring(game:HttpGet('https://raw.githubusercontent.com/EuroFM/tzechco-PlsDonateAutofarmBackup/main/hl.lib.lua'))()
end)
...
local Window = library:AddWindow("💘 @szze can someone get me potassium 🙏",
  {
